...
## 共通
電気分野の高橋開人、電子分野の水野拓真、機械分野の水野俊太、情報科の小松迅人、多田隆人、吉田瞬吏です。  
よろしくお願いします。⭐︎
```
- 科学技術科
  - 電気分野 高橋開人
...
合わせる前に元からNFCタグに情報を入れておき、簡易的に動かしてみました。
...
- `concurrent.futures` はマルチスレッドという同時処理をおこなうため  
...
A* はゴールまでの直線距離も計算し、ゴール側に寄って走査するため効率よく探索できます。
...
放置するだけで様々な条件下で何度でもシミュレートできるようにもなっています。  
